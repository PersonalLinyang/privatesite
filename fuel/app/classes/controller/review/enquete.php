...
class Controller_Review_Enquete extends Controller_App
{
	...
	public function action_index($param = null)
	{
		...
		//TDK
		$data['title'] = '来店感想投稿 - タンタンメン本舗';
		$data['description'] = 'タンタンメン本舗の来店感想投稿ページです。タンタンメン本舗は神奈川県横浜市坂東橋近くのタンタンメン専門店です。';
		$data['keywords'] = 'タンタンメン本舗,レビュー,感想,口コミ,投稿';
		$data['canonical'] = 'http://' . $_SERVER['HTTP_HOST'] . '/review/enquete/';
	...
	public function action_finish($param = null)
	{
		...
		//TDK
		$data['title'] = '来店感想投稿完了 - タンタンメン本舗';
		$data['description'] = 'タンタンメン本舗の来店感想投稿完了ページです。タンタンメン本舗は神奈川県横浜市坂東橋近くのタンタンメン専門店です。';
		$data['keywords'] = 'タンタンメン本舗,レビュー,感想,口コミ,投稿,完了';
		$data['canonical'] = 'http://' . $_SERVER['HTTP_HOST'] . '/review/enquete/finish/';
